...
const UpdatePatient = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://localhost:3000/patient/getpatient/${userData.user[0].PatientId}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    const data = {
      ...
      Latitude: userData.user[0].Latitude,
      Longitude: userData.user[0].Longitude,
      activation_token: userData.user[0].activation_token,
      newpass: newpassword,
    };
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:3000/patient/updatepatient/${userData.user[0].PatientId}`,
        data,
        config
      );
