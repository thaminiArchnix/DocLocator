...
const PatientDashboard = () => {
  ...
  const handleSearchSubmit = async (e) => {
    ...
    try {
      ...
      const doctorsWithinRadius = Object.values(allDoctorsData).filter(
        (doctor) => {
      ...
      if (selectedLocation && doctorsWithinRadius.length > 0) {
        saveLocationToLocalStorage(
          selectedLocation.lat,
          selectedLocation.lng,
          doctorsWithinRadius[0].id,
          doctorsWithinRadius[0].full_name
        );
      }
    } catch (error) {
  ...
  return (
    <div className="d-block">
      ...
      <div className="row-sm-11 d-flex flex-wrap align-items-center jistify-content-center">
        <div className="col-sm-6 text-justify p-5">
          <h6>Welcome to DocLocator!</h6>
          <p>
            Whether you're at the clinic, in the comfort of your home, or on the
            move, DocLocator is here to help you make informed decisions and
            receive personalized care. Join our community of patients committed
            to improving health outcomes and accessing innovative healthcare
            solutions. Together, let's pave the way for a brighter future in
            medicine and revolutionize the delivery of healthcare for everyone's
            benefit.
          </p>
        </div>
      ...
      <div className="d-flex justify-content-center gap-3 pt-5 flex-wrap">
        <div className="col-sm-8 p-0 d-flex flex-column gap-2 ">
          <div className="row p-5 bg-dark-subtle rounded">
            <h3 className="p-1 text-center">Find Your Doctor</h3>
            <br></br>
