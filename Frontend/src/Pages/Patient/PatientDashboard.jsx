...
const PatientDashboard = () => {
  return (
    <div className='d-block'>
      ...
      <h5 className='p-5'>Hello, Miss, Neha Gunasekara</h5>
      ...
      <div className='d-flex justify-content-center gap-3 pt-5 flex-wrap'>
        <div className="col-sm-8 p-0 d-flex flex-column gap-2 ">
          <div className="row p-5 bg-dark-subtle rounded">
            ...
            <div className='p-2'>
              <PatientDashOngoingCard name="Jenny Carter" age="32" gender="Female" startTime="11.30 a.m." endTime="12.30 p.m." location="123, Union Place, Colombo"/>
            </div>
          </div>
          <div className="row p-5 bg-dark-subtle rounded">
