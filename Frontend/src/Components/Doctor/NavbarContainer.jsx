  ...
  return (
    ...
    >
      ...
      <Nav className="mx-auto align-items-center d-flex flex-wrap text-white">
        ...
        <Link
          to="../doctor/dashboard"
          className="text-center p-3 text-white text-decoration-none"
        >
          Home
        </Link>
        <Link
      ...
      <div className="mx-3 d-flex text-center justify-content-center">
        <Button className="mr-3" variant="primary" onClick={handleLogout}>
          Logout
        </Button>{" "}
      </div>
    </Navbar>
